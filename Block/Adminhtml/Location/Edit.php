<?php
/**
 * Zacatrus Events Admin Location Edit Block
 *
 * @category    Zacatrus
 * @package     Zaca_Events
 * @author      Zacatrus
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if ($this->_coreRegistry->registry('zaca_events_location')->getId()) {
            return __("Edit Location '%1'", $this->escapeHtml($this->_coreRegistry->registry('zaca_events_location')->getName()));
        } else {
