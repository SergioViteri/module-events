<?php
/**
 * Zacatrus Events Admin Theme Edit Block
 *
 * @category    Zacatrus
 * @package     Zaca_Events
 * @author      Zacatrus
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        if ($this->_coreRegistry->registry('zaca_events_theme')->getId()) {
            return __("Edit Theme '%1'", $this->escapeHtml($this->_coreRegistry->registry('zaca_events_theme')->getName()));
        } else {
            return __('New Theme');
        }
    }
